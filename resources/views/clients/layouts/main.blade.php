                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('template/assets/img/trending/trending_top2.jpg') }}" alt="">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('template/assets/img/trending/trending_top3.jpg') }}" alt="">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('template/assets/img/trending/trending_top4.jpg') }}" alt="">
                                        <div class="trend-top-cap trend-top-cap2">
